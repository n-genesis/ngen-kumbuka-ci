                ...
                <div class="col-lg-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="<?= site_url('login') ?>" class="btn btn-primary"><?= lang('Landing.cardTwoLink') ?></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card text-center">
                        ...
                        <?php if (setting('Auth.allowRegistration')): ?>
                            <div class="card-body">
                                ...
                                <p class="mb-0"><a href="<?= url_to('register') ?>"><?= lang('Auth.needAccountLinkText') ?></a> <?= lang('Auth.needAccountText')?> 
                            </p>
                            </div>
                        <?php else: ?>
                            <div class="card-body">
                                ...
                                <p class="mb-0"><?= lang('Landing.cardThreeBody') ?> <a href="<?= site_url('support') ?>"><?= lang('Landing.cardThreeLink') ?></a>.</p>
                            </div>    
                        <?php endif ?>
                    </div>
                </div>
