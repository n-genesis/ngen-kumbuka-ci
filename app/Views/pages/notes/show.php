        ...
        <div id="noteCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://placehold.net/600x400.png" class="d-block w-100" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img src="https://placehold.net/600x400.png" class="d-block w-100" alt="Second slide">
                </div>
            </div>
