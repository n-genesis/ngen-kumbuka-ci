                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-12"><a role="contentinfo" class="accordion-title collapsed"
                                                ...
                                                aria-expanded="false" aria-controls="collapseThree"><span>Etiam sit amet
                                                    justo non </span> </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-12"><a role="contentinfo" class="accordion-title collapsed"
                                                ...
                                                aria-controls="collapseFive"><span> Donec volutpat metus in erat </span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-12"><a role="contentinfo" class="accordion-title collapsed"
                                                ...
                                                aria-controls="collapseSix"><span> quam quis massa tristique </span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
