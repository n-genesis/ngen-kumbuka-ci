<!-- app/Views/pages/search/index.php -->
    ...
    <div class="col-lg-12">
        <div class="search-result-box card-box">
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="pt-3 pb-4">
                        <div class="input-group">
                            <input type="text" id="" name="" class="form-control" value="Search........">
            ...
            <ul class="nav nav-tabs tabs-bordered">
                <li class="nav-item"><a href="#home" data-toggle="tab" aria-expanded="true" class="nav-link active">All
                        results <span class="badge badge-success ml-1">325</span></a></li>
                <li class="nav-item"><a href="#users" data-toggle="tab" aria-expanded="false" class="nav-link">Users
                        <span class="badge badge-danger ml-1">89</span></a></li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="search-item">
                                ...
                                <p class="mb-0 text-muted">Dolor posuere proin blandit accumsan senectus netus nullam
                                    curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum,
                                    tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis
                                    dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius
                                ...
                                <div class="media"><img class="d-flex mr-3 rounded-circle"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="font-13"><b>Email:</b> <span><a href="#"
                                                    class="text-muted">mediaheader@mail.com</a></span></p>
                                        <p class="mb-0 font-13"><b>Bio:</b>
                                            <br><span class="text-muted">Cras sit amet nibh libero, in gravida nulla.
                        ...
                        <div class="media mt-1"><img class="d-flex mr-3 rounded-circle"
                            ...
                            <div class="media-body">
                                ...
                                <p class="font-13"><b>Email:</b> <span><a href="#"
                                            class="text-muted">mediaheader@mail.com</a></span></p>
                                <p class="mb-0 font-13"><b>Bio:</b>
                                    <br><span class="text-muted">Cras sit amet nibh libero, in gravida nulla. Nulla vel
