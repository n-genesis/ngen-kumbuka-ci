    ...
    <div class="data-scrollbar" data-scroll="1">
        ...
        <div class="sidebar-btn dropdown mb-3">
            ...
            <div class="dropdown-menu w-100 border-0 py-3" aria-labelledby="dropdownMenuButton01">
                <a class="dropdown-item mb-2" href="page-new-note.html?type=blank">
                    <span><i class="bi bi-journal-plus"></i> Blank Notes</span>
                </a>
                <a class="dropdown-item mb-2" href="page-new-note-1.html?type=todo">
                    <span><i class="bi bi-check2-square"></i> To-do</span>
                </a>
                <a class="dropdown-item mb-2" href="page-new-note-2.html?type=essay">
                    <span><i class="bi bi-journal-bookmark"></i> Essay Notes</span>
                </a>
                <a class="dropdown-item" href="page-new-note-3.html?type=daily">
                    <span><i class="bi bi-calendar2-heart"></i> Daily Reflection</span>
                </a>
            </div>
        </div>
            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="">
                    <a href="page-reminder.html" class="svg-icon">
                        <i>
                            <svg width="20" class="svg-icon" id="iq-main-6" xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="" data-extra-toggle="right-sidebar">
                    <a href="javascript:void(0);" class="svg-icon">
                        <i>
                            <svg width="20" class="svg-icon" id="iq-main-7" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li class="">
                    <a href="page-bin.html" class="svg-icon">
                        <i>
                            <svg width="20" class="svg-icon" id="iq-main-8" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <ul id="ui" class="iq-submenu collapse" data-parent="#otherpage">
                                ...
                                <li class="">
                                    <a href="ui-buttons.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-ui-1-4" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <li class="">
                                    <a href="ui-images.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-ui-1-12" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                ...
                                <li class="">
                                    <a href="auth-recoverpw.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-auth-1-3" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <li class="">
                                    <a href="auth-confirm-mail.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-auth-1-4" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li class="">
                            <a href="#pricing" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">
                                <i>
                                    <svg class="svg-icon" id="iq-extra-1-3" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <ul id="pricing" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="pricing.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-extra-1-3-1" xmlns="http://www.w3.org/2000/svg"
                                                width="20" viewbox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <li class="">
                                    <a href="pricing-1.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-extra-1-3-2" xmlns="http://www.w3.org/2000/svg"
                                                width="20" viewbox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            ...
                            <ul id="pages-error" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="pages-error.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon feather feather-alert-circle" id="iq-extra-1-4-1"
                                                xmlns="http://www.w3.org/2000/svg" width="20" viewbox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <li class="">
                                    <a href="pages-error-500.html" class="svg-icon">
                                        <i class="">
                                            <svg class="svg-icon" id="iq-extra-1-4-2" xmlns="http://www.w3.org/2000/svg"
                                                width="20" viewbox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <li class="">
                            <a href="pages-blank-page.html" class="svg-icon">
                                <i class="">
                                    <svg class="svg-icon" id="iq-extra-1-8" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <li class="">
                            <a href="pages-maintenance.html" class="svg-icon">
                                <i class="">
                                    <svg class="svg-icon" id="iq-extra-1-9" xmlns="http://www.w3.org/2000/svg"
                                        width="20" viewbox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
