        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="iq-note-callapse-menu">
                <a class="iq-note-callapse-btn show-note-button" data-toggle="collapse" href="#collapseMenu"
                    ...
                    <i class="bi bi-pencil-square pr-2"></i>Write Your Note
                </a>
                <span class="hide-note-button d-none">
                    <i class="bi bi-folder pr-2"></i>Folder
                </span>
            </div>
                ...
                <div class="view-btn btn-dropdown body-bg rounded">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1">
                            <a class="dropdown-item" href="#"><i class="bi bi-heart mr-3"></i>Add
                                To Favourite</a>
                            <a class="dropdown-item" href="#"><i class="bi bi-bookmark mr-3"></i>Mark As
                                Pin</a>
                            <a class="dropdown-item" href="#"><i class="bi bi-x-circle mr-3"></i>Move to
                                Trash</a>
                        </div>
                    </div>
                </div>
        ...
        <ul class="list-inline m-0 p-0 d-flex align-items-center justify-content-around">
            ...
            <li class="nav-item nav-icon dropdown">
                <a href="#" class="text-dark search-toggle dropdown-toggle nav-icon-1" id="dropdownMenuButton1"
                    ...
                    <span class="badge badge-info count-mail mail rounded-circle">2</span>
            ...
            <li class="nav-item nav-icon dropdown pl-3">
                <a href="#" class="text-dark search-toggle dropdown-toggle nav-icon-1" id="dropdownMenuButton2"
                    ...
                    <span class="badge badge-info count-mail rounded-circle">2</span>
                    <span class="bg-primary"></span>
                </a>
                <!-- Dropdown Menu -->
