            ...
            <div class="modal-body">
                <div class="popup text-left">
                    <div class="media align-items-top justify-content-between">
                        ...
                        <div class="btn-cancel p-0" data-dismiss="modal"><i class="bi bi-x-lg"></i></div>
                    </div>
                    ...
                    <div class="media align-items-top justify-content-between">
                        ...
                        <div class="media align-items-center">
                            <a href="#" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="pin content"><i class="bi bi-bookmark mr-2"></i></a>
                            <div class="btn-cancel p-0" data-dismiss="modal"><i class="bi bi-x-lg"></i>
                            </div>
                        </div>
                    </div>
                    <div class="content create-workform">
                        <p>You can easily share via message, WhatsApp, emails etc. You can also save your
                ...
                <div class="popup text-left">
                    ...
                    <div class="content create-workform">
                        ...
                        <div class="checkbox mb-2">
                            ...
                            <label for="checkbox15" class="note-checkbox mb-0">Chapter 3 practical
                                File</label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content create-workform mb-4">
                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                            <li class="col-md-4 mb-4">
                                <a href="#">
                                    <img src="assets/images/gallery/grid/01.jpg" class="img-fluid rounded avatar-150"
                                        alt="">
                                </a>
                            </li>
                            <li class="col-md-4 mb-4">
                                <a href="#">
                                    <img src="assets/images/gallery/grid/02.jpg" class="img-fluid rounded avatar-150"
                                        alt="">
                                </a>
                            </li>
                            <li class="col-md-4 mb-4">
                                <a href="#">
                                    <img src="assets/images/gallery/grid/03.jpg" class="img-fluid rounded avatar-150"
                                        alt="">
                                </a>
                            </li>
                            <li class="col-md-4">
                                <a href="#">
                                    <img src="assets/images/gallery/grid/04.jpg" class="img-fluid rounded avatar-150"
                                        alt="">
                                </a>
                            </li>
                            <li class="col-md-4">
                                <a href="#">
                                    <img src="assets/images/gallery/grid/05.jpg" class="img-fluid rounded avatar-150"
                                        alt="">
                                </a>
                            </li>
                            <li class="col-md-4">
                                <a href="#">
                                    <img src="assets/images/gallery/grid/06.jpg" class="img-fluid rounded avatar-150"
                                        alt="">
                                </a>
                            </li>
                        </ul>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="popup text-left">
                    ...
                    <div class="content create-workform">
                        <p>Take organized notes and share later as meeting minutes or check-list with this
                            simple accessible Noteplus.</p>
                        <h4 class="mb-3">Shared</h4>
                        <ul class="list-inline p-0 m-0">
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="assets/images/user/04.jpg"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="assets/images/user/05.jpg"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="popup text-left">
                    ...
                    <div class="content create-workform">
                        <p>Need to write a summary note of the subject you just finished? NotePlus lets you
                            do in on-the-go!</p>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="popup text-left">
                    ...
                    <div class="content create-workform">
                        <p>Quickly note down the address and email address on NotePlus so that you can
                        ...
                        <ul class="list-inline p-0 m-0">
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="assets/images/user/06.jpg"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="assets/images/user/07.jpg"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="assets/images/user/08.jpg"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="assets/images/user/09.jpg"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="popup text-left">
                    ...
                    <div class="content create-workform">
                        <p>With NotePlus, you can easily share via message, WhatsApp, emails etc. You can
                            also save your notes and edit it later or can easily delete the note.</p>
                    </div>
                </div>
            </div>
        </div>
