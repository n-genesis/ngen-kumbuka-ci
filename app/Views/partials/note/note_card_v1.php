...
<?php foreach ($userNotes as $note): ?>
    <div class="<?= isset($noteCardClass) ? $noteCardClass : 'col-lg-6 col-md-6' ?>">
                    ...
                    <?php if (auth()->loggedIn()): ?>
                        ...
                        <?php if ($note->user_id != auth()->user()->id): ?>
                            ...
                            <?php else: ?>
                                ...
                                <button type="submit" title="You've shared this note" class="btn btn-outline-primary mr-2" data-km="button">
